# Application Exercise 1: GitHub and Julia

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is the repository for Application Exercise 1 for [BEE 4750](https://viveks.me/environmental-data-analysis), taught at [Cornell University](https://cornell.edu) in Fall 2023 by [Vivek Srikrishnan](https://viveks.me).

If enrolled in the class, a PDF of the completed exercise, **with all cells evaluated**, should be submitted to Gradescope *no later* than Friday, August 25, 2023, at 9:00pm. 10% will be deducted for each day that the notebook is late.

## Learning Objectives

After completing this application exercise, students will be able to:

- clone a GitHub repository;
- open and edit a Jupyter notebook;
- write and evaluate basic Julia code;
- export a Jupyter notebook to a PDF.
...
- `ae01.ipynb`: Jupyter Notebook for the homework assignment. Students should create code or Markdown blocks as necessary to answer questions. **This is the only file you should need to edit.**
...
- `ae01.qmd`: Source file for Jupyter notebook generation. You shouldn't need to or want to touch this; everything is in the `.ipynb` file.
...
2. Opening the notebook will depend on what you decided to do in the previous step. 
  - If you installed VS Code, you should be able to just open `ae01.ipynb` and everything should just work. 
  ...
  - If you want to use `IJulia.jl`, open a Julia prompt. You can do this by:
    - Using the `Julia-1.8` or equivalent graphical program, type `cd("BEE4750/aes")` or whatever path points to your lab notebook folder;
    - Navigating to your `BEE4750/aes/ae01` folder and typing `julia` to open the prompt.Then:
      ...
      notebook()
      ```
      and you can navigate to and open `ae01.ipynb`.
